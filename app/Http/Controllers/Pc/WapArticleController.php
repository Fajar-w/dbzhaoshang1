...
class WapArticleController extends Controller
{
    /**普通文档
    ...
    public function GetArticles($id)
    {
         ...
         //   dd($postarr->term_id);
            ...
            // $prev_article = Project::find($this->getPrevArticleId($postarr->ID,$postarr->pterm_id));
            // $next_article = Project::find($this->getNextArticleId($postarr->ID,$postarr->pterm_id));


             return view('wap.article_article',compact('postarr','prev_article','next_article','arcTm','id','arcdh','ptermsfl','post_content','termsfl','matchimg','desc'));
    ...
    public function GetNews($id)
    {
        ...
        if(strstr($path,'news/')){
            $postarr =  cache()->remember('wappostarr_'.$id, 5, function() use($id){
           ...
           // dd($prev_article);
            $next_article = $this->getNextArticleId($postarr->ID,$postarr->pterm_id);
             ...
             return view('wap.news_article',compact('postarr','prev_article','next_article','arcTm','id','arcdh','ptermsfl','post_content','xgydnews','termsfl'));
         }
    ...
    {
         return  cache()->remember('wapgetPrevArticleId_'.$id.'_'.$pterm_id, $this->times(), function () use ($id,$pterm_id) {
    ...
    {
         return  cache()->remember('wapgetNextArticleId_'.$id.'_'.$pterm_id, $this->times(), function () use ($id,$pterm_id) {
              return News::select('ID','post_title')->where('status','1')->where('pterm_id',$pterm_id)->where('ID', '>', $id)->first();
            });
