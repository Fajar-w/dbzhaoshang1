...
class RulesController extends BaseController
{
    ...
    public function store(RuleRequest $request)
    {
        ...
        return redirect()->route('rules.index')->with('success', '添加权限成功');
    }
    ...
    public function update(RuleRequest $request, $id)
    {
        ...
        if(is_null($rule))
        {
            ...
            return redirect()->route('rules.index')->with('error', '你无权操作');
        }

        $rule->update($request->all());
        // flash('更新成功')->success()->important();

        return redirect()->route('rules.index')->with('success', '更新成功');
    }
    ...
    public function destroy($id)
    {
        ...
        if(empty($rule))
        {
            ...
            return redirect()->route('rules.index')->with('error', '删除失败');
        }
        ...
        return redirect()->route('rules.index')->with('success', '删除成功');
    }
    ...
    public function status($status,$id)
    {
        ...
        if(empty($rule))
        {
            ...
            return redirect()->route('rules.index')->with('error', '操作失败');
        }
        ...
        return redirect()->route('rules.index')->with('success', '更新状态成功');
    }
}
