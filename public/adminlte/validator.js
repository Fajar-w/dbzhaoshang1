...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,
        ...
        email_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]]/,
        phone_filter = /^(13[0-9]{9})|(18[0-9]{9})|(14[0-9]{9})|(17[0-9]{9})|(15[0-9]{9})$/,
        ...
        message = {
            ...
            phone_repeat    : 'phone do not match',
    ...
    function testByType(type, value){
        ...
        if( !type || type == 'password' || type == 'phone' || type == 'search' || type == 'file' )
            type = 'text';
