...
<div class="con fr">
<ul class="clearfix">
<li class="active"><a href="/xm">不限</a></li>
...
@endforeach
    ...
    <input type="hidden" id="lslug" value="">
...
<div class="fr">项目库共<span>{{$total}}</span>个匹配项目</div>
</div>
 ...
 @foreach($pagelists as $k=>$v)
         <li class="clearfix">
            ...
            <div class="label clearfix">
                {!! \Common::xmgetcate($v->pterm_id,$v->term_id) !!}
            </div>
            </div>
...
@else
      {!! str_replace('class="active"><span>','><span class="active">',str_replace('">','">',str_replace("?page=","xm/page/",$pagelists->links()))) !!}
@endif                
        @endif
</div>
</div>
...
$tuijProjectArr = \Common::getPosts('-1','',6); 
