                    ...
                    <h3 class="box-title">文档发布总计{{$articles->total()}}</h3><p>
                       ...
                       <div class="form-group">
                            <div class="input-group">
                                 ...
                                 <select class="form-control select2" style="width: 150px" id="selectd" name="term_id">
