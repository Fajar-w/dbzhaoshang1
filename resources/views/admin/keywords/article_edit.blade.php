...
@section('content')
    <!-- row -->
    <div class="row">
        {{Form::model($articleinfos,array('route' =>array( 'keyarticle_edit','id'=>$id),'method' => 'post','files' => true,))}}
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-body basic_info">
                            ...
                            <div class="form-group col-md-12">
                                {{Form::label('subtitle', '副标题', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                              <div class="col-md-4 col-sm-9 col-xs-12">
                                 ...
                                 <div class="col-md-4 col-sm-9 col-xs-12">
                                   <select class="form-control select2" style="width: 100%" id="selectd" name='term_id'>
                                        ...
                                        @forelse($topnavs as $v)
                                                ...
                                                <option value="{{$v->term_id}}" @if($articleinfos->term_id==$v->term_id) selected = "selected" @endif>{{$v->name}}</option>
