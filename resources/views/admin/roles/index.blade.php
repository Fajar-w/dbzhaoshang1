                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <a href="{{route('roles.edit',$item->id)}}"><button class="btn btn btn-warning btn-xs" type="button"><i class="fa fa-paste"></i> 修改</button></a>
                                <form class="form-common" action="{{ route('roles.destroy', $item->id) }}" method="post" style="margin:0px;display:inline;">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
