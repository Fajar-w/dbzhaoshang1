...
@section('content')
        <!-- row -->
<div class="row">
   <form class="form-horizontal m-t-md" action="/admin/spage/create" method="post">
                {!! csrf_field() !!}
    <div class="col-md-12">
        <!-- The time line -->
        <ul class="timeline">
                ...
                <li>
                 ...
                 <div class="timeline-item">
                        ...
                        <div class="timeline-body basic_info">
                            ...
                            <div class="form-group col-md-12">
                                {{Form::label('post_name', 'url', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                <div class="col-md-4 col-sm-9 col-xs-12">
